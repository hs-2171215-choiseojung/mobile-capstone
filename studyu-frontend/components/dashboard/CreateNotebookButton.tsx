  ...
  return (
    <>
      <button
        ...
        disabled={loading}
        className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold bg-brand-600 text-white hover:bg-brand-700 transition-colors shadow-sm disabled:opacity-60 disabled:cursor-not-allowed"
      >
        {loading ? (
            ...
            <div className="px-6 py-5 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-surface-300 text-sm text-surface-900 outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-100 transition-all"
                  autoFocus
                />
              </div>
